package com.ecomerce.dao.custom.base;
...
public interface CoreDao<T extends BaseMaster> extends FindLayerDao<T> {
	 ...
	 * set results could be ordered, and fetching join columns.
	 * 
	 * @param propertyName
	 *            the property name
	 * @param value
	 ...
	 * @see com.ecomerce.dao.custom.base.util.PropCriteriaAndValue
	 */
	 ...
	 * @return PaginationResult<T>
	 */
	PaginationResult<T> paginateAll(List<String> leftJoinFetchColumns,
	 ...
	 * @return true, if successful {@inheritDoc}
	 */
	boolean removeBulkUsingFilter(List<PropCriteriaAndValue> filter,
			Boolean... and);
